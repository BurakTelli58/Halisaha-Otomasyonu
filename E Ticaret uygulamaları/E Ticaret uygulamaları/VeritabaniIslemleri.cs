...
namespace E_Ticaret_uygulamalarý
{
    class VeritabaniIslemleri
    {
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-IHP923N\SQLEXPRESS;Initial Catalog=HalýsahaOtomasyonu;Integrated Security=True;Encrypt=False");
